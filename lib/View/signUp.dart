    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Padding(
          ...
          child: Text("Create Account",style: TextStyle(color: const Color.fromRGBO(2, 84, 100, 1),fontSize:  ScreenUtil().setSp(30))),
        ),
      ),
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    prefixIcon: const Icon(Icons.lock_outline_rounded),
                    suffixIcon:isConfirmPasswordVisible? IconButton(onPressed: (){ setState(() {
                ...
                Row(
                  ...
                  children: [
                    ...
                    }, child: const Text("sign In",style: TextStyle(color: Color.fromRGBO(2, 84, 100, 1)),))
                  ],
                ),
              ],
            ),
